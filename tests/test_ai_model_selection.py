...
class SurveyAppTest(unittest.TestCase):
    ...
    def test_ai_model_selection(self):
        ...
        # verifying if ChatGPT is selected
        selected_button = self.driver.find_element(MobileBy.XPATH, "//XCUIElementTypeButton[@name='ChatGPT']")
        self.assertEqual(selected_button.get_attribute("name"), "ChatGPT")
